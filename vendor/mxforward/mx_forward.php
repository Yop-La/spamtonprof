...
class MxForward
{
    ...
    private $api_url = 'https://forwardmx.io/api';
    ...
    {
        $this->api_key = 'g7AkoadILbiyRl9oxyd1F_cowQDdCtWaS4E';
        if (! empty($api_url)) {
    ...
    public function getDomains()
    {
        ...
        return $this->call('domains?' . $this->setParams($params));
    }
    ...
    public function addDomain(string $domain)
    {
        ...
        return $this->call('domains/create?' . $this->setParams($params));
    }
