<?php 
				...
				/*
					Ce script sert à attribuer le tag paj (pas à jour) aux parents actifs. Il s'inscrit dans le processus de maj des comptes sur getresponse
					Il tourne plusieurs fois dans la nuit avant le script de maj des parents
				...
				*/
					...
					$parentActif = $getresponse->getContactsSearchContacts('jcUD');
					...
					to_log_slack(array("str1" => "cron exécuté le " .$now -> format('l jS \of F Y h:i:s A') ,"str2" => "set tag paj parent" ));
