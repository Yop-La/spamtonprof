...
// toutes ces fonction seront executes par un appel ajax realise dans adds-back-office.js sur la page dont le slug est adds
...
// verifie que la cat choisie n'existe pas a la fois dans baseTextes et textes
...
function ajaxGenerateAndSaveTexts()
{
    ...
    // pour lier les nouvelles ligne de la table texte a la table type_texte
    // on ajoute d'ailleurs le type a cette table
