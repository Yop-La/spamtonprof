...
$filters_rennes_immo = '{"filters":{"category":{"id":"9"},"enums":{"ad_type":["offer"]},"keywords":{"parrot_used":7},"location":{"locations":[{"area":{"default_radius":5000,"lat":48.10717427604917,"lng":-1.6693251892374632,"radius":5000},"city":"Rennes","department_id":"35","label":"Rennes (toute la ville)","locationType":"city","region_id":"6"}]},"ranges":{}}}';
...
$lbc_api->extract_from_ads($lbc_api::vente_immo, "Le Mans", "", false, $filters_le_mans_immo);



$ads_immo_mg = new \spamtonprof\stp_api\LbcAdsImmoManager();
$ads_immo_mg->update_view_prix_moyen_rennes();