...
/**
 * ce script sert :
 * - � compter les messages envoy�s par les �l�ves durant les 7 derniers jours
 *
 * fonctionnement :
 * 1�) compter les messages des 7 derniers jours dans stp_message_eleve
 * 2�) mettre � jour la colonne nb_message dans stp_message_eleve
 *
...
// r�cup�rer les messages et les comptes des abonnements avec nb_messages != 0
$nbMessages = $aboMg->getNbMessage();

// mettre tous les messages � z�ro
...
// mettre � jour les messages non nulles dans algolia :
$refAbos = [];
